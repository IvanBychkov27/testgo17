...
%{
	...
	PHP_INI_BEGIN()
	PHP_INI_ENTRY("f51degrees.data_file", "/usr/lib/php5/51Degrees.trie", PHP_INI_ALL, NULL)
	PHP_INI_ENTRY("f51degrees.property_list", "", PHP_INI_ALL, NULL)
	PHP_INI_END()
	#endif
...
%minit {
	...
	char *filePath = INI_STR("f51degrees.data_file");
	char *propertyList = INI_STR("f51degrees.property_list");
